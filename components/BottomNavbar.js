  ...
  return (
    <div className="md:hidden">
      <nav className="fixed bottom-0 inset-x-0 bg-white flex justify-between text-sm text-gray-500 uppercase font-mono top">
        <Link href="/">
          <a className="w-full block py-3 px-3 text-center hover:bg-red-200 hover:text-red-500 transition duration-300">
            <svg
        ...
        <Link href="/">
          <a className="w-full block py-3 px-3 text-center hover:bg-red-200 hover:text-red-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 mb-2 mx-auto"
              fill="none"
